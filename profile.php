    ...
    <div class="profile-page">
        ...
        <div class="profile-header">
            ...
            <div class="profile-info">
                <h1><?= htmlspecialchars($user_info['name'] . ' ' . $user_info['surname']) ?></h1>
                <p class="username">@<?= htmlspecialchars($user_info['username']) ?></p>
                <div class="member-badges">
                    ...
                    <span class="badge badge-info">
                        ...
                        عضو از: <?= jdate('Y/m/d', strtotime($user_info['created_at'])) ?>
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="profile-stats">
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    <div class="stat-number"><?= $user_stats['active_reservations'] ?></div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    <div class="stat-number"><?= $user_stats['returned_reservations'] ?></div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-content">
                    <div class="stat-number"><?= number_format($total_penalty) ?></div>
                ...
                <form method="POST" action="" class="profile-form">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="surname" id="surname" class="form-control" 
                                   value="<?= htmlspecialchars($user_info['surname']) ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="username" id="username" class="form-control" 
                               value="<?= htmlspecialchars($user_info['username']) ?>" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="address" id="address" class="form-control" rows="3"><?= htmlspecialchars($user_info['address'] ?? '') ?></textarea>
                    </div>
                            ...
                            <div class="activity-item">
                                ...
                                <div class="activity-content">
                                    ...
                                    <div class="activity-time">
                                        <i class="fas fa-clock"></i>
                                        <?= jdate('Y/m/d H:i', strtotime($activity['created_at'])) ?>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
