    ...
    <div class="reservations-page">
        ...
        <div class="filters-bar">
            <div class="filter-tabs">
                ...
                <a href="?status=returned" class="filter-tab <?php echo  $status_filter == 'returned' ? 'active' : '' ?>">
                    برگشت داده شده
                </a>
            </div>

            <div class="results-count">
                <?php echo  number_format($total_reservations) ?> امانت
            </div>
        </div>
                ...
                <?php foreach ($reservations as $res): ?>
                    <div class="reservation-card">
                        <div class="reservation-image">
                            <img src="<?php echo  IMG_PATH . $res['image'] ?>"
                                 alt="<?php echo  htmlspecialchars($res['book_name']) ?>"
                        ...
                        <div class="reservation-details">
                            <div class="reservation-header">
                                <h3 class="reservation-title">
                                    <a href="book.php?id=<?php echo  $res['bid'] ?>">
                                        <?php echo  htmlspecialchars($res['book_name']) ?>
                                    </a>
                                </h3>
                            ...
                            <p class="reservation-category">
                                ...
                                <?php echo  htmlspecialchars($res['category_name']) ?>
                            </p>
                            ...
                            <div class="reservation-dates">
                                <div class="date-item">
                                    ...
                                    <span class="date-value"><?php echo  jdate('Y/m/d', strtotime($res['borrow_date'])) ?></span>
                                </div>

                                <div class="date-item">
                                    <i class="fas fa-calendar-check"></i>
                                    <span class="date-label">تاریخ بازگشت:</span>
                                    <span class="date-value"><?php echo  jdate('Y/m/d', strtotime($res['due_date'])) ?></span>
                                </div>
                                ...
                                <?php if ($res['actual_status'] == 'active'): ?>
                                    <div class="date-item">
                                        ...
                                        <span class="date-value <?php echo  $res['days_remaining'] < 0 ? 'text-danger' : '' ?>">
                                            <?php if ($res['days_remaining'] >= 0): ?>
                                                <?php echo  $res['days_remaining'] ?> روز
                                            <?php else: ?>
                                                <?php echo  abs($res['days_remaining']) ?> روز تأخیر
                                            <?php endif; ?>
                                        </span>
                                    </div>
                                <?php endif; ?>
                                ...
                                <?php if ($res['actual_status'] == 'returned' && $res['return_date']): ?>
                                    <div class="date-item">
                                        ...
                                        <span class="date-value"><?php echo  jdate('Y/m/d', strtotime($res['return_date'])) ?></span>
                                    </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <?php if ($res['extension_count'] > 0): ?>
                                <div class="extension-info">
                                    ...
                                    این امانت <?php echo  $res['extension_count'] ?> بار تمدید شده است
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if ($res['penalty_amount'] > 0): ?>
                                <div class="penalty-info">
                                    <i class="fas fa-exclamation-triangle"></i>
                                    جریمه: <?php echo  number_format($res['penalty_amount']) ?> تومان
                        ...
                        <div class="reservation-actions">
                            <a href="book.php?id=<?php echo  $res['bid'] ?>" class="btn btn-outline btn-sm">
                            ...
                            <?php if ($res['actual_status'] == 'active'): ?>
                                ...
                                <?php if ($can_extend): ?>
                                    <form method="POST" action="" style="display: inline;">
                                        <input type="hidden" name="reservation_id" value="<?php echo  $res['rid'] ?>">
                                        <button type="submit" name="extend_reservation" class="btn btn-primary btn-sm"
                                            ...
                                            <i class="fas fa-redo"></i>
                                            تمدید (<?php echo  $max_extensions - $res['extension_count'] ?> بار باقیمانده)
                                        </button>
                                    </form>
                                <?php else: ?>
                            ...
                            <?php if ($res['penalty_amount'] > 0 && $res['penalty_status'] == 'unpaid'): ?>
                                <a href="payment.php?reservation_id=<?php echo  $res['rid'] ?>" class="btn btn-danger btn-sm">
